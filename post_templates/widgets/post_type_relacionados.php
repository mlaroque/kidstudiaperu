...
<h2> Conoce Otras <?php  echo $posttype_obj->name; ?> </h2>
<div class="container">
    <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center td33 brdr brdb" valign="top">
                                            ...
                                            <br><b
                                                class="xl25"><?php echo get_post_meta( $current_post->ID, 'escuela_ficha_costo', true );	?></b>
                                        </td>
                                        <td class="text-center td33 brdr brdb" valign="top">
                                ...
                                <tbody>
                                    <tr class="BGverde">
                                        <td colspan="2" class="text-center" valign="middle">
                                            <b class="xl35 blanco"><?php echo $current_post->post_title;	?></b>
