...
<div class="container" style="margin-top: 20px">
	<div class="row ficha_signo-A">
		<div class="col-12 col-sm-3 col-md-3 col-lg-3 text-center">
			...
			<p>Es signo de: <b class="capital"><?php echo get_post_meta( $post->ID, 'ficha_elemento', true );	?></b></p>
			<p>Número de la suerte: <b class="capital"><?php echo get_post_meta( $post->ID, 'ficha_num_suerte', true );	?></b></p>
			<p>Color: <b class="capital"><?php echo get_post_meta( $post->ID, 'ficha_color', true );	?></b></p>  
				...
				<tr>
					...
					<td valign="middle">
						...
						<?php foreach($planetas as $planeta): ?>
							<img src="<?php echo get_template_directory_uri() . '/images/trans.gif';?>" data-src="<?php echo get_image_by_value('p-'.$planeta,'svg');?>" class="lazy-img">
						<?php endforeach;?>
					</td>
				</tr>
				<tr>
	...
	<div class="container" style="margin: 40px auto;">
		<div class="row">
			...
			<div class="col-12 col-sm-6 col-md-7 col-lg-7 SignCaract mt20">
				<p>Polaridad: <b class="capital"><?php echo get_post_meta( $post->ID, 'signo_carac_polaridad', true );	?></b></p>
				<p>Modalidad: <b class="capital"><?php echo get_post_meta( $post->ID, 'signo_carac_modalidad', true );	?></b></p>
				<p>Casa Regente: <b class="capital"><?php echo get_post_meta( $post->ID, 'signo_carac_casa', true );	?></b></p>
				<p>Parte del cuerpo: <b class="capital"><?php echo get_post_meta( $post->ID, 'signo_carac_cuerpo', true );	?></b></p>
				<p>Planeta Regente: <b class="capital"><?php echo get_post_meta( $post->ID, 'signo_carac_planeta', true );	?></b></p>
				<p>Piedras del signo: <b class="capital"><?php echo get_post_meta( $post->ID, 'ficha_piedra', true );	?></b></p>
			</div>
